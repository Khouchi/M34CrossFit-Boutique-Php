...
$context["action"], "type", [], "any", true, true) && ($this->getAttribute($context["action"], "type", []) == "button"))) {
    ...
    {
        return new Source("", "PrestaShopBundle:Admin/Helpers:bootstrap_popup.html.twig", "C:\\wamp64\\www\\test-boutique\\src\\PrestaShopBundle/Resources/views/Admin/Helpers/bootstrap_popup.html.twig");
    }
}
